      ...
      <Tilt>
        <div className="container h-96 w-96 bg-white bg-opacity-10 rounded-2xl shadow-5xl relative z-2 border border-opacity-30 border-r-0 border-b-0 backdrop-filter backdrop-blur-sm">
          <form className='h-full flex flex-col justify-evenly items-center'>
            ...
            <input type="text" placeholder='Email' className='placeholder:text-gray-500 pl-[14px] input-text rounded h-9  bg-white bg-opacity-50 hover:bg-white hover:bg-opacity-80'/>
            <input type="password" placeholder='password' className='placeholder:text-gray-500 pl-[14px] input-text h-9  rounded bg-white bg-opacity-50 hover:bg-white hover:bg-opacity-80'/>
